    ...
    <div className="rounded-div flex items-center justify-between h-20 font-bold">
      <Link to="/">
        <h1 className="text-2xl">
          Crypto<span className="text-[#DB592A]">Mania</span>
        </h1>
      </Link>
      ...
      {user?.email ? (
        <div>
          ...
          className="bg-button text-btnText px-5 py-2 ml-2 rounded-2xl shadow-lg hover:shadow-2xl">Sign Out</button>
        </div>
      ) : (
        <div className="hidden md:block">
      ...
      : 'fixed left-[-100%] rop-20 h-[90%] flex flex-col items-center justify-between ease-in-out duration-300'}>
