        ...
        <div>
          <div className='flex justify-between'>
            {coin.market_data?.current_price ? (
              <p className='text-3xl font-bold'>R${coin.market_data.current_price.brl.toLocaleString()}</p>
            ) : null}
            <p>7 Day</p>
          </div>
          <div>
          ...
          <div className='flex justify-between py-4'>
            <div>
              ...
              {coin.market_data?.market_cap ? (
                <p>R${coin.market_data.market_cap.brl.toLocaleString()}</p>
              ) : null}
            </div>
            <div>
              <p className='text-gray-500 text-sm'>Volume (24h)</p>
              {coin.market_data?.market_cap ? (
                <p>R${coin.market_data.total_volume.brl.toLocaleString()}</p>
              ) : null}
            </div>
          </div>
          ...
          <div className='flex justify-between py-4'>
            <div>
              ...
              {coin.market_data?.high_24h ? (
                <p>R${coin.market_data.high_24h.brl.toLocaleString()}</p>
              ) : null}
            </div>
            <div>
              <p className='text-gray-500 text-sm'>24h Low</p>
              {coin.market_data?.low_24h ? (
                <p>R${coin.market_data.low_24h.brl.toLocaleString()}</p>
              ) : null}
            </div>
          </div>
        </div>
